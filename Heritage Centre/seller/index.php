<?php
    ...
    function sellerLogin(){
        ...
        if(isset($_POST['loginBtn'])){
            ...
            $selectBuyer = "SELECT * FROM seller WHERE email='$buyerEmail' AND password='$buyerPassword'";
            $runSelectBuyer = mysqli_query($db, $selectBuyer);
            $buyerId = mysqli_fetch_array($runSelectBuyer)['sellerid'];
...
<head>
    ...
    <title>Heritage Centre | SELLER LOG IN</title>
